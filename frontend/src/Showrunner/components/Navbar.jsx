...
const Navbar = () => {
  ...
  return (
    <AppBar position="sticky" sx={{height:"80px",justifyContent:"center",backgroundColor:"#222831",mb:2,}}>
      <StyledToolbar>
        <Typography variant="h4" sx={{ display: { xs: "none", sm: "block", }, fontFamily:"'Nunito', sans-serif",}}>
          Insight Blend
        </Typography>
